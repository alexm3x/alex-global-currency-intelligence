    ...
    if (home && !document.getElementById("equityComparatorShortcut")) {
      ...
      shortcut.innerHTML = `
        <div class="section-heading">
          <div>
            <p class="rubric">AGCI FUNDAMENTAL LAB</p>
            <h2>Analice y edite hasta 10 acciones</h2>
            <p>Compare P/E, P/S, EV/EBITDA, FCF Yield, crecimiento, márgenes, ROE, ROIC, deuda y empresas semejantes.</p>
          </div>
          <button type="button" class="link-button" id="openEquityComparator">Abrir comparador →</button>
        </div>`;
